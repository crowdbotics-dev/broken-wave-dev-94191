"""
Django settings for broken_wave_dev_94191 project.
...
ROOT_URLCONF = 'broken_wave_dev_94191.urls'
...
WSGI_APPLICATION = 'broken_wave_dev_94191.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_wave_dev_94191 API",
    "DESCRIPTION": "API documentation for broken_wave_dev_94191 App",
    "VERSION": "v1",
}
